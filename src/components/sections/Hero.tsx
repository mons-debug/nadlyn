      ...
      <div className="container mx-auto px-4 flex-1 flex flex-col">
        ...
        <div className="flex flex-col-reverse lg:flex-row gap-6 lg:gap-16 items-center flex-1">
          ...
          <div className="flex-1 space-y-6 lg:space-y-8 text-center lg:text-left">
            <AnimatedSection>
              <motion.h1 
                className="text-4xl sm:text-5xl lg:text-7xl font-bold leading-tight text-neutral-900 mb-4 lg:mb-6"
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            <AnimatedSection delay={0.3}>
              <motion.div
                className="grid grid-cols-2 gap-3 pt-4 lg:hidden max-w-md mx-auto"
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.3, duration: 0.4 }}
              >
                {benefits.slice(0, 2).map((benefit, index) => (
                  <motion.div
                    key={index}
                    className="flex items-center gap-2 p-3 rounded-lg bg-white/60 border border-neutral-200"
                    whileHover={{ scale: 1.02 }}
                  >
            ...
            <AnimatedSection delay={0.4}>
              <motion.div
                className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 pt-4 lg:pt-6"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
